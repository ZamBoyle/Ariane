...
|---|---|---|---|---|---|
| linux | 826 / 826 | 188 | 28 | 7 | 7 |
| macos | 826 / 826 | 188 | 28 | 7 | 7 |
| windows | 810 / 811 | 188 | 28 | 7 | 7 |
...
`npm run test:coverage` — **96,82 % des lignes, 88,12 % des branches, 95,16 % des fonctions.**
